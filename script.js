...
const aggiornaK = () => {
  ...
  kValueDisplay.textContent = `${valoreK} (lt/mm)`;
};
...
const converti = () => {
  ...
  if (tipoConversione === 'toTonnellate') {
    ...
    risultato = valore / K;
    risultatoDiv.textContent = `${valore.toLocaleString()} lt equivalgono a ${risultato.toLocaleString('it-IT', { maximumFractionDigits: 2 })} mm.`;
  }
};
